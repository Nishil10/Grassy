...
export const GoogleAuth = () => {
    ...
    const setupGoogleAuth = () => {
        if (window.google) {
            ...
            if (signInBtn) {
                // Create custom dark button without white Google logo background
                signInBtn.innerHTML = '';
                ...
                customButton.addEventListener('mouseenter', () => {
                    customButton.style.backgroundColor = '#00000';
                });
                customButton.addEventListener('mouseleave', () => {
                    customButton.style.backgroundColor = '#000000';
                });
                
                // Add click handler that triggers Google Sign-In
                customButton.addEventListener('click', () => {
                    if (window.google && window.google.accounts) {
                        // Create a temporary invisible element for Google to render its button
                        ...
                        // Render Google's button in the invisible element
