...
export const RegisterForm = () => {
    ...
    const handleSubmit = async (evt) => {
        ...
        try {
            ...
            navigate('/');
            alert(`Welcome, ${formData.displayName}! Your account has been ccreated successfuly.`);
        } catch (err) {
            console.log("Registration error: ", err);
            
            let errMessage = "Registration failed. Please try agaib.";
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row items-center justify-between max-w-6xl w-full">
            {inputErrors.general && (
